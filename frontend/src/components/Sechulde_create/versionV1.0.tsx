...
//         <div className="flex items-center space-x-2 sm:mb-0 mb-4 sm:justify-start justify-center relative">
//           <h1 className="text-2xl font-semibold">
//             {selectedMonth} {selectedYear}
//           </h1>
//           <div className="flex space-x-2">
//             <button
//               className="flex items-center text-blue-500 border border-blue-500 rounded px-2 py-1 text-sm"
...
//             >
//               Year <ChevronDown size={16} className="ml-1" />
//             </button>
//           </div>

//           {isMonthDropdownOpen && (
//             <div className="absolute top-12 left-0 z-10 w-48 bg-white border rounded-md shadow-lg">
//               {months.map((month) => (
//                 <button
//                   key={month}
...
//           {isYearDropdownOpen && (
//             <div className="absolute top-12 left-32 z-10 w-32 bg-white border rounded-md shadow-lg">
//               {years.map((year) => (
//                 <button
//                   key={year}
//                   className="block w-full text-left px-4 py-2 hover:bg-gray-100"
