...
const FullScreenContactForm = () => {
  ...
  return (
    <div className="flex items-start justify-start p-4 sm:p-12 w-full h-full" style={{ position: 'absolute' }}>
      <div className="w-[876px] h-full p-6 rounded-md">
        <form onSubmit={handleSubmit}>
          <div className="mb-5">
            <h1 className="text-2xl sm:text-4xl font-medium mb-1">Contact us</h1>
            <p className="text-base sm:text-lg text-gray-400 mb-6">Reach out and we'll get in touch within 24 hours.</p>
          </div>
          <div className="mb-5">
            <label htmlFor="title" className="block text-base sm:text-lg font-bold text-black mb-1">
              Title
            </label>
            <input
              type="title"
          ...
          <div className="mb-5">
            <label htmlFor="message" className="mb-3 block text-base sm:text-lg font-bold text-black">
              Message
            </label>
            <textarea
              rows={4}
          ...
          <div className="mb-5 flex items-center">
            <input
              ...
              required
            />
            <label htmlFor="policy" className="text-base sm:text-lg text-gray-600 mt-2 sm:mt-0">
              You agree to our friendly <a href="/privacy-policy" className="text-blue-500 hover:underline">privacy policy</a>.
            </label>
          </div>
          <div>
            <button
