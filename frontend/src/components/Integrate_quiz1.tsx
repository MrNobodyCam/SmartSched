          ...
          <div className="bg-white rounded-lg shadow-lg w-full max-w-md relative">
            ...
            <div className="p-6">
              ...
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 bg-red-400 rounded-lg" />
              ...
              {/* Description */}
              <div className="flex gap-3 text-gray-600 mb-8">
              ...
              <div className="flex gap-4 justify-end">
                <button className="flex items-center gap-2 px-6 py-2.5 text-orange-500 bg-white rounded-md hover:bg-orange-50 shadow-sm border border-gray-100">
                  <span className="transform rotate-45">✏️</span>
                  Edit
                </button>
                <button className="px-6 py-2.5 bg-blue-500 text-white rounded-md hover:bg-blue-600 shadow-sm">
                  Quiz Score: 5/5
                </button>
              </div>
            </div>
